...
# with command line options: step3 --conditions 92X_upgrade2017_realistic_forECALStudies_ZeroN -n 10 --era Run2_2017 --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,EI,PAT,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_EI_PAT_VALIDATION_DQM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_EI_PAT_VALIDATION_DQM_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_EI_PAT_VALIDATION_DQM_inDQM.root'),
